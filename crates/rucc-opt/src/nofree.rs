...
///
/// These twenty eight and no more. The rest of what the runtime exports is the allocator's own
/// bookkeeping, `__rucc_alloc_purge` and the frame calls and the rest, and those are exactly the
/// things that do end a lifetime. Nothing generated calls them, so leaving them out costs nothing,
/// and a name added here without reading what it does would be a hole in the safety this compiler
/// is for.
///
...
const RUNTIME_NEVER_FREES: &[&str] = &[
    ...
    "__rucc_check_free",
    "__rucc_check_init",
    "__rucc_check_init_range",
    "__rucc_check_init_strided",
    "__rucc_check_live",
    "__rucc_check_race",
    "__rucc_check_type",
    "__rucc_check_type_range",
    "__rucc_check_type_strided",
    "__rucc_check_typed_init",
    "__rucc_check_typed_init_range",
