...
pub struct Summary {
    ...
    /// Restrict checks, judgement J8, which is document 03's Y8 asked of the block an access is in.
    ///
    /// Zero unless the build asked for them with `-fsafety-restrict`, and even then far fewer than
