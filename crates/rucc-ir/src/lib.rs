...
#![doc(html_root_url = "https://docs.rs/rucc-ir/0.4.1")]
...
pub use inst::{
    ...
    ImmList, Inst, InstData, InstLayout, MemInfo, Meta, MetaNode, Param, Restrict, Sig, Signature,
    SlotList, SwitchInfo, VaInfo, Value, ValueData, ValueList, ValueRef,
};
pub use module::{
