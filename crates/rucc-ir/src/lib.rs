...
#![doc(html_root_url = "https://docs.rs/rucc-ir/0.3.14")]
...
pub use inst::{
    ...
    ImmList, Inst, InstData, InstLayout, MemInfo, Meta, MetaNode, Param, Sig, Signature, SlotList,
    SwitchInfo, VaInfo, Value, ValueData, ValueList, ValueRef,
};
pub use module::{
