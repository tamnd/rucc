...
block0(%0: i32, %1: ptr):
    ...
    %16 = call_indirect.nofree %1(%0) : (i32) -> i32
...
global @table : bytes 32 = { bytes \"hi\\00\\ff\\\"\\\\\", zero 2, i32 7, addr.8 @hi.str + 8, addr.8 @hi.str - 8, away.4 @hi.str + 1 }, align 8, linkage(external), constant, section \".rodata.rel\"
