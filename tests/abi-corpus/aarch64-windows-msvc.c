...
_Static_assert(__builtin_offsetof(struct gen_07, m2) == 24, "offsetof struct gen_07.m2");
...
struct gen_35 {
	short m0;	/* +0 */
	struct bits_trailing_zero_width m1[2];	/* +2 */
	unsigned char m2[3];	/* +4 */
	unsigned short m3;	/* +8 */
};
_Static_assert(sizeof(struct gen_35) == 10, "sizeof struct gen_35");
_Static_assert(_Alignof(struct gen_35) == 2, "_Alignof struct gen_35");
_Static_assert(__builtin_offsetof(struct gen_35, m0) == 0, "offsetof struct gen_35.m0");
_Static_assert(__builtin_offsetof(struct gen_35, m1) == 2, "offsetof struct gen_35.m1");
_Static_assert(__builtin_offsetof(struct gen_35, m2) == 4, "offsetof struct gen_35.m2");
_Static_assert(__builtin_offsetof(struct gen_35, m3) == 8, "offsetof struct gen_35.m3");
...
_Static_assert(__builtin_offsetof(struct gen_41, m5) == 42, "offsetof struct gen_41.m5");
