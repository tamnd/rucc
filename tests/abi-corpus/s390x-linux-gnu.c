/* Record layout for s390x-linux-gnu, as rucc computes it.
 *
...
_Static_assert(sizeof(struct long_double_pair) == 24, "sizeof struct long_double_pair");
...
_Static_assert(sizeof(struct int128_pair) == 24, "sizeof struct int128_pair");
_Static_assert(_Alignof(struct int128_pair) == 8, "_Alignof struct int128_pair");
_Static_assert(__builtin_offsetof(struct int128_pair, m0) == 0, "offsetof struct int128_pair.m0");
_Static_assert(__builtin_offsetof(struct int128_pair, m1) == 8, "offsetof struct int128_pair.m1");
...
_Static_assert(_Alignof(union union_of_the_widest) == 8, "_Alignof union union_of_the_widest");
...
_Static_assert(sizeof(struct gen_02) == 56, "sizeof struct gen_02");
...
_Static_assert(__builtin_offsetof(struct gen_02, m3) == 40, "offsetof struct gen_02.m3");
...
_Static_assert(sizeof(struct gen_16) == 40, "sizeof struct gen_16");
...
_Static_assert(__builtin_offsetof(struct gen_16, m3) == 32, "offsetof struct gen_16.m3");
...
_Static_assert(sizeof(struct gen_20) == 24, "sizeof struct gen_20");
...
_Static_assert(sizeof(union gen_43) == 24, "sizeof union gen_43");
