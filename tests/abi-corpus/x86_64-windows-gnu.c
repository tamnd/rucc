/* Record layout for x86_64-windows-gnu, as rucc computes it.
 *
...
_Static_assert(__builtin_offsetof(struct alignas_over_long_double, m2) == 48, "offsetof struct alignas_over_long_double.m2");
...
_Static_assert(sizeof(struct long_double_pair) == 32, "sizeof struct long_double_pair");
_Static_assert(_Alignof(struct long_double_pair) == 16, "_Alignof struct long_double_pair");
...
_Static_assert(__builtin_offsetof(struct gen_16, m2) == 20, "offsetof struct gen_16.m2");
...
struct gen_27 {
	...
	_Alignas(16) unsigned char m4;	/* +128 */
};
_Static_assert(sizeof(struct gen_27) == 160, "sizeof struct gen_27");
...
_Static_assert(__builtin_offsetof(struct gen_27, m4) == 128, "offsetof struct gen_27.m4");
