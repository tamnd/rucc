...
struct gen_35 {
	...
	unsigned char m2[3];	/* +10 */
	unsigned short m3;	/* +14 */
};
_Static_assert(sizeof(struct gen_35) == 16, "sizeof struct gen_35");
...
_Static_assert(__builtin_offsetof(struct gen_35, m2) == 10, "offsetof struct gen_35.m2");
_Static_assert(__builtin_offsetof(struct gen_35, m3) == 14, "offsetof struct gen_35.m3");
